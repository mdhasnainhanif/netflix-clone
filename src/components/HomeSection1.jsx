          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="mt-16 md:mt-0">
              <div className="relative">
                ...
                <video className="max-[1532px]:w-[68%] absolute top-[22%] left-[15%] md:top-[21%] md:left-[75px] lg:w-[70%] 2xl:w-[400px] md:w-[63%] w-[80%]" width="63%" src={videoTV} autoPlay loop muted></video>
              </div>
            </div>
          </div>
        </div>
